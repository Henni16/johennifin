...
- **Purpose**: Replaced the "Jellyfin" name with "JoHennifin" across UI visible strings, storefront metadata, logos, and hardcoded user-visible system references.
- **Affected Files**:
  ...
  - `app/src/main/res/drawable-v24/app_logo.xml`
  - `app/src/main/java/org/jellyfin/androidtv/ui/preference/category/about.kt`
  - `app/src/main/java/org/jellyfin/androidtv/ui/startup/fragment/SelectServerFragment.kt`
  - `app/src/main/java/org/jellyfin/androidtv/ui/startup/fragment/UserLoginFragment.kt`
  ...
  - `fastlane/metadata/android/en-GB/**/*.txt`
  - `fastlane/metadata/android/de/**/*.txt`
